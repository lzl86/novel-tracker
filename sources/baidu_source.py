"""
Baidu Search Source.
Searches Baidu for novel updates and extracts latest chapter information and links.
"""
...
class BaiduSearchSource(BaseSource):
    ...
    async def search(self, novel_name: str) -> List[NovelSearchResult]:
        ...
        url = f"https://www.baidu.com/s?wd={encoded_query}&rn=15"
        ...
        try:
            async with httpx.AsyncClient(
                ...
                for item in containers:
                    ...
                    # Also check for special chapters like 终章, 大结局
                    ...
                    # Pick the one with the highest chapter number
                    best_ch_title = ""
                    best_ch_num = -1.0
